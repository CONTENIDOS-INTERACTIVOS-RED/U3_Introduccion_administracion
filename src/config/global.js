  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '2',
        titulo: 'Innovación y gestión del cambio en las organizaciones',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Gestión del cambio en las organizaciones',
            hash: 't_2_2',
          },
        ],
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Responsabilidad social empresarial y sostenibilidad',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
